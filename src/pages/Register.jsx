        ...
        <div className="glass-panel-futuristic p-8 rounded-3xl border border-[#AEB6C2]/12 hover:border-[#AEB6C2]/20 shadow-[0_0_50px_rgba(174, 182, 194,0.08)] hover:shadow-[0_0_60px_rgba(174, 182, 194,0.18)] transition-all duration-500 relative z-10 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1.5 group">
              ...
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3.5 flex items-center pointer-events-none">
                  <User className="h-4.5 w-4.5 text-zinc-600 group-focus-within:text-[#AEB6C2] transition-colors duration-300" />
                </div>
                <input
                  type="text"
                  ...
                  required
                  disabled={loading}
                  className="w-full pl-10 pr-4 py-3 bg-black/40 border border-zinc-800/80 rounded-xl focus:border-[#AEB6C2]/60 focus:bg-[#050608]/80 focus:outline-none focus:shadow-[0_0_15px_rgba(174, 182, 194,0.15)] placeholder-zinc-700 text-zinc-200 text-sm transition-all duration-300 font-medium disabled:opacity-50"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5 group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  minLength={6}
                  disabled={loading}
                  className="w-full pl-10 pr-10 py-3 bg-black/40 border border-zinc-800/80 rounded-xl focus:border-[#AEB6C2]/60 focus:bg-[#050608]/80 focus:outline-none focus:shadow-[0_0_15px_rgba(174, 182, 194,0.15)] placeholder-zinc-700 text-zinc-200 text-sm transition-all duration-300 font-mono font-medium disabled:opacity-50"
                />
                <button
                  type="button"
            ...
            <div className="text-center text-xs text-zinc-600 mt-6 font-mono font-medium">
              ALREADY INITIALIZED?{' '}
              <Link to="/login" className="font-bold text-zinc-400 hover:text-[#AEB6C2] transition-colors uppercase ml-1">
                ACCESS SYSTEM
              </Link>
            </div>
