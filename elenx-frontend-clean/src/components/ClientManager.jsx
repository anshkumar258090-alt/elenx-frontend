...
const ClientManager = () => {
    ...
    const getAccessBadge = (type) => {
        switch (type) {
            case 'internal': return <span className="px-2 py-1 bg-blue-500/20 text-blue-400 text-xs font-bold rounded uppercase flex items-center gap-1"><Shield size={12} /> Internal</span>;
            case 'external': return <span className="px-2 py-1 bg-green-500/20 text-green-400 text-xs font-bold rounded uppercase flex items-center gap-1"><FileCode size={12} /> External</span>;
            ...
            default: return <span className="px-2 py-1 bg-gray-500/20 text-gray-400 text-xs font-bold rounded uppercase">Unknown</span>;
        }
    };
    ...
    return (
        <div className="space-y-8">
            ...
            <motion.div
                ...
                className="glass-panel p-8 rounded-3xl border border-white/10 shadow-xl bg-white/5 backdrop-blur-md"
            >
                ...
                <form onSubmit={handleCreateClient} className="space-y-4">
                    <div>
                        <label className="block text-gray-400 text-sm mb-2">Select Product Access</label>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <input
                            ...
                            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-blue-500 text-white placeholder-gray-500 transition-all"
                            required
                        />
                        <input
                            type="text"
                    ...
                    <button type="submit" className="w-full py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white font-bold rounded-xl hover:shadow-lg hover:shadow-blue-500/30 transition-all">
                        Generate User
                    </button>
                </form>
            </motion.div>
            ...
            >
                <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                    <Users className="text-purple-500" /> Manage User Pass
                </h3>
                    ...
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-white/5">
                            ...
                            {clients.filter(c => c.role !== 'admin').length === 0 && (
                                <tr>
                                    <td colSpan="4" className="py-8 text-center text-gray-500 italic">No users found. Create one above.</td>
                                </tr>
                            )}
                        </tbody>
                    </table>
                ...
                {editingUser && (
                    ...
                    >
                        ...
                        >
                            ...
                            <h3 className="text-xl font-bold text-white mb-6 flex items-center gap-2">
                                <Edit className="text-blue-500" /> Edit User
                            </h3>
