...
class ErrorBoundary extends React.Component {
 ...
 <p className="text-zinc-400 mb-6 font-medium">An unexpected error occurred in the application. Please try refreshing.</p>
 {this.state.error && (
 <div className="bg-red-900/20 text-red-400 p-4 rounded-xl text-left text-sm overflow-auto mb-6 max-h-40 border border-red-500/30">
